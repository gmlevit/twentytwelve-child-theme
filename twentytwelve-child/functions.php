...
function twentytwelve_child_enqueue_parent() {
    wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css' );
}
add_action( 'wp_enqueue_scripts', 'twentytwelve_child_enqueue_parent' );
...
add_action( 'wp_enqueue_scripts', 'twentytwelve_child_enqueue_child', 11 );
